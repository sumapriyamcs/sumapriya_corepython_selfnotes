...
'''
# getter - RETRIEVE
print("Madhu name :", getattr(suma, "name"))
print("Madhu eid  :", getattr(suma, "eid"))
# print("Madhu addr  :", getattr(suma, "addr"))

# setter - UPDATE
print("Setting name :", setattr(suma, "name", "MAD"))
print("Setting eid  :", setattr(suma, "eid", 200))
print("Setting addr :", setattr(suma, "address", 'Bangalore'))

print("Get name:", getattr(suma, "name"))
print("Get eid :", getattr(suma, "eid"))
print("Get addr:", getattr(suma, "address"))

print("Has attr sal :", hasattr(suma, "sal"))
print("Has attr addr:", hasattr(suma, "address"))

print("Delete attr :", delattr(suma, "sal"))
