...
suma = Employee()
suma.getdata(10)  17th line
suma.getdata(10,'suma')  19th line
suma.getdata(10,'suma',1000) 21st line
...
getdata(10)
getdata(10,'suma')
getdata(10,'suma',1000)   
getdata(name='suma', sal=1000) 
getdata(name='suma')
getdata(sal=1000) 
...
getdata(10, 'suma')        # getdata(id=10,name='Madhu',sal=None)
getdata(10, 'suma', 1000)  # getdata(id=10,name='Madhu',sal=1000)
